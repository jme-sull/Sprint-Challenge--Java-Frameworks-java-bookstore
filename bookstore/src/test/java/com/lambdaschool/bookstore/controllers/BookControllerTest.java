...
import com.lambdaschool.bookstore.config.ResourceServerConfig;
...
public class BookControllerTest
{
            ...
            Exception
    {
        ...
        Mockito.when(bookService.findBookById(2)).thenReturn(bookList.get(1));
            ...
            Exception
    {
        ...
        Mockito.when(bookService.findBookById(100)).thenReturn(bookList.get(1));
            ...
            Exception
    {
        ...
        s1.setSectionid(6);
        Book b1 = new Book("Neverwhere", "9780738206752", 2001, s1);
        ObjectMapper mapper = new ObjectMapper();
    ...
    public void updateFullBook() throws Exception
    {
        ...
        s1.setSectionid(7);
        Book b1 = new Book("Dreamcatcher", "978073820er6752", 2001, s1);
